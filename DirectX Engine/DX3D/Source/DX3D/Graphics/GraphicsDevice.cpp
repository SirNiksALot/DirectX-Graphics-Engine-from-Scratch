...
RefPtr<SwapChain> dx3d::GraphicsDevice::createSwapChain(const SwapChainDesc& desc) const
{
...
RefPtr<VertexShaderSignature> dx3d::GraphicsDevice::createVertexSignature(const VertexShaderSignatureDesc& desc)
{
